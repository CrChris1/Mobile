...
function App({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Pagina de Cadastro</Text>
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Cadastro">
        <Stack.Screen name="Cadastro" component={App} options={{title:"", headerStyle:{backgroundColor: '#191970'}}}/>
        <Stack.Screen name="ListarUsuarios" component={ListarUsuarios} options={{title: '', headerStyle:{backgroundColor: '#191970'}}} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
